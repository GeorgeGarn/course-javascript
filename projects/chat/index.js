import './index.html';
import './css/main.css';
import messageTemplate from './templates/chat-message.hbs';
import noticeTemplate from './templates/chat-notice.hbs';
import userTemplate from './templates/user-template.hbs';
import modalTemplate from './templates/avatar-dialog.hbs';
...
function sendLogin(e) {
  ...
  if (field !== '') {
    ...
    alert('Поле НИК не должно быть пустым');
  }
}
